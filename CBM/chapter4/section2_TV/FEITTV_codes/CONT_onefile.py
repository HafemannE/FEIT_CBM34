...
class InverseProblem(ForwardProblem):
    ...
    def __init__(self, mesh, V, data, I_all):
        ...
        self.Cellsgamma_k=np.ones(mesh.num_cells())           #First guess for Forwardproblem
    ...
    """
        ...
        while res_vec[self.steps]/100>=self.tau*self.noise_level and self.steps<=self.step_limit:
            ...
            self.gamma_k.vector()[:]=self.Cellsgamma_k  #Vector to function
    ...
    def dev_app_vec(self, sk):
        ...
        eta = Function(self.Q_DG)
        eta.vector[:]=vector_dev
    ...
    def set_firstguess(self, Cellsgamma_k):
        ...
        self.gamma_k[:]=self.Cellsgamma_k #Guess in cell function """
